...
![Comparison between different propagation approaches for the computation of running diffusion coefficients. $10^3$ protons with $E=10^{15}$ eV simulated in magnetic field configurations described in the text. Detailed explanations and the code respectively the data for the reproducibility are available in tutorial \footnote{[https://gitlab.ruhr-uni-bochum.de/reichp2y/rwpropa/-/blob/master/rwpropa/tutorials/Tutorial_4---Tutorial_Comparison_CRPropa.ipynb](https://gitlab.ruhr-uni-bochum.de/reichp2y/rwpropa/-/blob/master/rwpropa/tutorials/Tutorial_4---Tutorial_Comparison_CRPropa.ipynb)}. \label{fig:comparison}](figure_comparison.pdf)
