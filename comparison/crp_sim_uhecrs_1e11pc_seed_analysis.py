...
path = 'uhecrs_1e11pc_seed_analysis/'
path_figs = 'uhecrs_1e11pc_seed_analysis/figures'
path_data = 'uhecrs_1e11pc_seed_analysis/data'
path_data_raw = 'uhecrs_1e11pc_seed_analysis/data/raw_data'
...
for i, seed in enumerate(range(nr_seeds)):
    crp = CRPropa(step_size = step_size, l_min = 5*10**9, traj_max = 3e21, path = path, prop_module = prop_module, kappa = kappa_theory, turbulence_method = 'PW', seed_study = True, random_seed = seed)
