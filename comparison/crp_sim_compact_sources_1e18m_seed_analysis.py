...
path = 'compact_sources_1e18m_seed_analysis/'
path_figs = 'compact_sources_1e18m_seed_analysis/figures'
path_data = 'compact_sources_1e18m_seed_analysis/data'
path_data_raw = 'compact_sources_1e18m_seed_analysis/data/raw_data'
...
for i, seed in enumerate(range(nr_seeds)):
    crp = CRPropa(energy=2*10**17, step_size = step_size, l_min = 5*10**9, traj_max = 10**18, path = path, prop_module = prop_module, kappa = kappa_theory, turbulence_method = 'PW', seed_study = True, random_seed = seed)
