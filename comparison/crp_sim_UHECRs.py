...
for i, step_size in enumerate(step_sizes[:10]):
    crp = CRPropa(energy = 1e19, bmrs = 10**(-9), l_max = 5*10**6*pc, l_min = 5*10**4*pc, step_size = step_size, traj_max = 10**11*pc, path = path, prop_module = prop_module, kappa = kappa_theory)
